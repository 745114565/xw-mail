...
public class DateUtil {
	...
	public static String getDateFormatZero(String time) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		Date date = sdf.parse(time);
		return sdf.format(date);
	}

	public static String getDateFormatZero2(String time) throws ParseException {
	...
	public static DateStyle getDateStyle(String date) {
		...
		for (DateStyle style : DateStyle.values()) {
			...
			DateFormat df = new SimpleDateFormat(style.getValue());
			String dtmp = df.format(dateTmp);
			if (dtmp.equals(date)) {
	 ...
	 * @return
	 */
	public static boolean isLastDay(String date, DateStyle dateStyle) {
		Date dt = StringToDate(date, dateStyle);
	 ...
	 * @return
	 */
	public static boolean isFirstDay(String date, DateStyle dateStyle) {
		Date dt = StringToDate(date, dateStyle);
		Calendar c = Calendar.getInstance();
		c.setTime(dt);
		int d = c.get(Calendar.DAY_OF_MONTH);
	...
	public static void main(String[] args) throws ParseException {
		// String str = "2016-11-01 02:10:00";
		// String param = DateUtil.getAzkTime(str);
		// System.out.println(param);
		// System.out.println(DateUtil.getAzkDate(str));
		//

		String str = "20161101";
		String param = DateUtil.StringToString(str, DateStyle.YYYYMMDD,
				DateStyle.YYYY_MM_DD);
		System.out.println(param);
		
		String ss = DateUtil.stampToDate(new Date().getTime());
		System.out.println(ss);
		Date curDate = DateUtil.addDay(new Date(), -1);
		String sss = DateUtil.stampToDate(curDate.getTime());
	...
	public static String getAzkDate(String date) {
		return DateUtil.StringToString(date, DateStyle.YYYY_MM_DD_HH_MM,
				DateStyle.MM_DD_YYYY_EN);
	}

	public static String getAzkTime(String date) {

		String tmp = DateUtil.StringToString(date, DateStyle.YYYY_MM_DD_HH_MM,
				DateStyle.HH_MM);
		int hour = DateUtil.getHour(tmp);
		int tmp2 = 0;
		String resulthour = hour + "";
		String tag = "AM";
		if (hour > 12) {
			hour = hour - 12;
			resulthour = "0" + hour;
			tag = "PM";
			return resulthour + "," + tmp.split(":")[1] + "," + tag + ",CST";
		} else {
			return tmp.replace(":", ",") + "," + tag + ",CST";
		}
	}
	...
	public static String getDqSheduledDate() {
		return DateUtil.DateToString(
				DateUtil.addMinute(
						DateUtil.StringToDate(DateUtil.getCurrentTime()), 10),
