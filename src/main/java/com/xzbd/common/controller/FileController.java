...
public class FileController extends BaseController {
	...
	public R remove(Long id, HttpServletRequest request) {
		...
		String fileName = xwMailConfig.getUploadPath() + sysFileService.get(id).getUrl().replace("/files/", "");
	...
	R upload(@RequestParam("file") MultipartFile file, HttpServletRequest request) {
		...
		try {
			FileUtil.uploadFile(file.getBytes(), xwMailConfig.getUploadPath(), fileName);
		} catch (Exception e) {
			return R.error();
		}
